...
//    private static int MEDIA_ERR_NONE_SUPPORTED = 4;
    ...
    /**
     * Set audio tempo rate.
     *
     * @param rate set speed of audio
     * @param file The name of the audio file.
     */
    public void setRate(float rate, String file) {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            ...
            Log.i("TAG", "currently setRate method not supporting below API 23");
        }
    }
